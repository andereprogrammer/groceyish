        ...
        <div className="review_rates">
          <div className="review_box">
            <div className="review">
              <span>5</span>
              <img src="/images/StarGreay.png" />
              <LinearBar bgcolor="#5CBF43" progress="50" height={20} />
              <span>(2)</span>
            </div>
            <div className="review">
              <span>4</span>
              <img src="/images/StarGreay.png" />
              <LinearBar bgcolor="#5CBF43" progress="0" height={20} />
              <span>(0)</span>
            </div>
            <div className="review">
              <span>3</span>
              <img src="/images/StarGreay.png" />
              <LinearBar bgcolor="#5CBF43" progress="20" height={20} />
              <span>(1)</span>
            </div>
            <div className="review">
              <span>2</span>
              <img src="/images/StarGreay.png" />
              <LinearBar bgcolor="#5CBF43" progress="30" height={20} />
              <span>(1)</span>
            </div>
            <div className="review">
              <span>1</span>
          ...
          <div className="rating_numbers">
            <div className="rating_star_number">
              <span>4</span>
              <img src="/images/Stargreen.png" alt="" />
            </div>
